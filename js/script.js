...
function changeBackground(clima){
	switch (clima){
		...
		case "Clouds":
		case "Partly Cloudy":
			$("body").css({'background-image': 'url(http://i.imgur.com/BTDElMu.jpg)'});
		break;
		case "Thunderstorm":
			$("body").css({'background-image': 'url(https://dreamlandia.com/images/T/thunderstorm.jpg)'});
		break;
		case "Drizzle":
			$("body").css({'background-image': 'url(http://turismosalobrena.com/wp-content/uploads/2016/03/efecto-lluvia-en-parabrisas-auto-7223.jpg)'});
		break;
		case "Rain":
			$("body").css({'background-image': 'url(http://i.imgur.com/ZLXhh8q.jpg)'});
		break;
		case "Snow":
		case "Snowy":
			$("body").css({'background-image': 'url(http://i.imgur.com/S5EDGHf.jpg)'});
		break;
		case "Atmosphere":
			$("body").css({'background-image': 'url(http://i.imgur.com/p0NfTAB.jpg)'});
		break;
		case "Extreme":
			$("body").css({'background-image': 'url(http://i.imgur.com/To7gGz1.jpg)'});
		break;
		case "Additional":
		case "Hurricane":
			$("body").css({'background-image': 'url(http://i.imgur.com/ad6Sat0.jpg)'});
		break;
		case "Clear":
			$("body").css({'background-image': 'url(http://i.imgur.com/ad6Sat0.jpg)'});
		break;
		default:
			$("body").css('background-image', 'url(https://images.alphacoders.com/684/684911.jpg)');
	}
}
